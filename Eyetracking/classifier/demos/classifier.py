...
# for N in {1..8}; do ./util/align-dlib.py train_images/raw align outerEyesAndNose train_images/aligned --size 96 & done
# Generate Representations
# ./batch-represent/main.lua -outDir features -data train_images/aligned
# ./demos/classifier.py train features
##test:
#./demos/classifier.py infer ./features/classifier.pkl exampleImages/testChris.jpg
