...
#MMIEyetrackingStream
#MMIClassifierStream

inlet_infos = pylsl.resolve_byprop("name", "MMIClassifierStream")
print("Found stream.")
...
while True:
    try:
        ...
        channel_id = lsl_stream_processor.get_channel_by_label(inlet_info,"name channel")
