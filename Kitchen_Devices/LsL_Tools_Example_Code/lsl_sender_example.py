...
outlet_info = pylsl.StreamInfo("Teststream",  # name
                               "event markers",  # type
                               2,  # channel_count
...
test_channel1.append_child_value("label", "testchannel1")
test_channel1.append_child_value("type", "event markers")
test_channel1.append_child_value("Zusatzinfo", "Dies ist der erste Testchannel!")

test_channel2 = channels.append_child("channel")
test_channel2.append_child_value("label", "testchannel2")
test_channel1.append_child_value("type", "event markers")
test_channel1.append_child_value("Zusatzinfo", "Dies ist der zweite Testchannel!")
